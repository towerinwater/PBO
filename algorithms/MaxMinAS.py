...
#     """
#     This class implements the Max-Min Ant System (MMAS) algorithm for binary optimization problems.
#     This is a variant of the Max Min Ant System (MMAS) algorithm adapted for binary problems.
#     """
#     def __init__(self, 
#                  budget: int, # number of iteration 
#                  name: str = "Max-Min Ant System",
...
#         self.C = C                             # pheromone deposit or `Q`
#         self.evaporation_rate = evaporate_rate # or `rho` 
...
#         while problem.state.evaluations < self.budget: # we can only do local search if we have budget left
